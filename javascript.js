...
const myIntrests = ["Reading", "Gaming", "Watching sports"];
...
if (userName !== "" && userAge >= 18 && userIsBlocked === false) {
  ...
  console.log("Could not log in, please check your information and try again.");
}
...
//Skrev først en ifelse statement
/* 
let userTitle = "";
